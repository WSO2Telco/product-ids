...
//        Assert.assertEquals(CaResources.CsrStatus.PENDING,csr1.getCsrMetaInfo().getStatus(),"CSR 1 is not in
// pending status");
//        CsrDTO csr2 = clientServiceClient.getCsr(serialNo2);
//        Assert.assertEquals(CaResources.CsrStatus.PENDING,csr2.getCsrMetaInfo().getStatus(),"CSR 2 is not in
// pending status");
//        adminServiceClient.signCSR(serialNo1, 30);
//        adminServiceClient.signCSR(serialNo2, 90);
//        csr1 = clientServiceClient.getCsr(serialNo1);
//        Assert.assertEquals(CaResources.CsrStatus.SIGNED,csr1.getCsrMetaInfo().getStatus(),"CSR 1 has not been
// signed");
//        csr2 = clientServiceClient.getCsr(serialNo2);
//        Assert.assertEquals(CaResources.CsrStatus.PENDING,csr2.getCsrMetaInfo().getStatus(),"CSR 2 has not been
// signed");
...
//        Assert.assertEquals(CaResources.CsrStatus.PENDING,csr.getCsrMetaInfo().getStatus(),"CSR 3 is not in pending
// status");
//        adminServiceClient.rejectCSR(serialNo3);
//        csr = clientServiceClient.getCsr(serialNo3);
//        Assert.assertEquals(CaResources.CsrStatus.REJECTED,csr.getCsrMetaInfo().getStatus(),"CSR 3 has not been
// Rejected");
//    }
