...
public class EntitlementServiceTestCase extends ISIntegrationTest {
    ...
    private static final String REQUEST = "<Request xmlns=\"urn:oasis:names:tc:xacml:3.0:core:schema:wd-17\" " +
            ...
            ".w3.org/2001/XMLSchema#string\">read</AttributeValue></Attribute></Attributes>" +
            "<Attributes Category=\"urn:oasis:names:tc:xacml:1.0:subject-category:access-subject\">" +
            "<Attribute AttributeId=\"urn:oasis:names:tc:xacml:1.0:subject:subject-id\" IncludeInResult=\"false\">" +
            "<AttributeValue DataType=\"http://www" +
            ".w3.org/2001/XMLSchema#string\">admin</AttributeValue></Attribute></Attributes>" +
    ...
    private static final String POLICY = "<Policy xmlns=\"urn:oasis:names:tc:xacml:3.0:core:schema:wd-17\"  " +
            ...
            "Version=\"1.0\">" +
            "<Description>sample policy</Description><Target></Target><Rule Effect=\"Permit\" " +
            "RuleId=\"primary-group-customer-rule\">" +
            "<Target><AnyOf><AllOf><Match MatchId=\"urn:oasis:names:tc:xacml:1.0:function:string-regexp-match\">" +
            "<AttributeValue DataType=\"http://www" +
            ".w3.org/2001/XMLSchema#string\">http://localhost:8280/services/echo/</AttributeValue>" +
            "<AttributeDesignator AttributeId=\"urn:oasis:names:tc:xacml:1.0:resource:resource-id\" " +
            "Category=\"urn:oasis:names:tc:xacml:3.0:attribute-category:resource\" DataType=\"http://www" +
            ".w3.org/2001/XMLSchema#string\" " +
            "MustBePresent=\"true\"></AttributeDesignator></Match><Match " +
            ...
            "MustBePresent=\"true\"></AttributeDesignator></Match></AllOf></AnyOf></Target>" +
            ...
            "Category=\"urn:oasis:names:tc:xacml:1.0:subject-category:access-subject\" DataType=\"http://www" +
            ".w3.org/2001/XMLSchema#string\" " +
            "MustBePresent=\"true\"></AttributeDesignator></Apply></Condition></Rule><Rule Effect=\"Deny\" " +
            "RuleId=\"deny-rule\"></Rule></Policy>";
    ...
    public void testPublishPolicy() throws Exception {
        ...
        entitlementPolicyClient.publishPolicies(new String[]{POLICY_ID}, new String[]{"PDP Subscriber"}, "CREATE",
                true, null, 1);
        Assert.assertNotNull(entitlementPolicyClient.getPolicy(POLICY_ID, true), "Entitlement service publish policy " +
                "failed.");
    }
    ...
    @Test(groups = "wso2.is", dependsOnMethods = {"testPublishPolicy"}, description = "Check get decision by " +
            "attributes")
    public void testGetDecisionByAttributes() throws EntitlementServiceException, RemoteException {
        String decision = entitlementServiceClient.getDecisionByAttributes("admin",
                "http://localhost:8280/services/echo/", "read", null);
        log.info(decision);
        Assert.assertTrue(decision.contains("Permit"), "Entitlement service get decision failed.");
    }

    @Test(groups = "wso2.is", dependsOnMethods = {"testGetDecisionByAttributes"}, description = "Check get decision " +
            "deny state")
