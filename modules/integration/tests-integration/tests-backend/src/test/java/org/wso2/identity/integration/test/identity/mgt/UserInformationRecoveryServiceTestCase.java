...
//    	confKey = bean.getKey();
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check verify confirmation code", dependsOnMethods =
            "testSendRecoveryNotification")
...
//    	String value = loginManger.login("user11", "passWord2@", isServer.getBackEndUrl());
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check getting all challenge questions", dependsOnMethods =
            "testSendRecoveryNotification")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check getting challenge question ids", dependsOnMethods =
            "testGetAllChallengeQuestions")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check get user challenge question", dependsOnMethods =
            "testGetUserChallengeQuestionIds")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check verify user challenge question", dependsOnMethods =
            "testGetUserChallengeQuestion")
...
//	}
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check user account verification", dependsOnMethods =
            "testVerifyUserChallengeAnswer")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check user registration confirmation", dependsOnMethods =
            "testRegisterUser")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check existing user registration validation", dependsOnMethods =
            "testRegisterUser")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check user registration validation with empty password",
            dependsOnMethods = "testRegisterUser")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check user registration validation with Invalid Claims",
            dependsOnMethods = "testRegisterUser")
    ...
    @SetEnvironment(executionEnvironments = {ExecutionEnvironment.ALL})
    @Test(groups = "wso2.is", description = "Check user registration validation with Invalid Tenant",
            dependsOnMethods = "testRegisterUser")
