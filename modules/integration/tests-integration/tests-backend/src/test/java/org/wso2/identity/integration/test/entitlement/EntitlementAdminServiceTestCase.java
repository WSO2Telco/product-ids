...
public class EntitlementAdminServiceTestCase extends ISIntegrationTest {
    ...
    private static final String REQUEST_1 = "<Request xmlns='urn:oasis:names:tc:xacml:2.0:context:schema:os' " +
            "xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' " +
            "xsi:schemaLocation='urn:oasis:names:tc:xacml:2.0:context:schema:os " +
            "access_control-xacml-2.0-context-schema-os.xsd'> <Subject> <Attribute " +
            "AttributeId='urn:oasis:names:tc:xacml:1.0:subject:subject-id' DataType='http://www" +
            ".w3.org/2001/XMLSchema#string'> <AttributeValue>admin</AttributeValue> </Attribute> </Subject> " +
            "<Resource> <Attribute AttributeId='urn:oasis:names:tc:xacml:1.0:resource:resource-id' " +
            "DataType='http://www.w3.org/2001/XMLSchema#string'> " +
            "<AttributeValue>http://localhost:8280/services/echo</AttributeValue> </Attribute> </Resource> <Action> " +
            "<Attribute AttributeId='urn:oasis:names:tc:xacml:1.0:action:action-id' DataType='http://www" +
            ".w3.org/2001/XMLSchema#string'> <AttributeValue>read</AttributeValue> </Attribute> </Action> " +
            "<Environment/> </Request>";
    ...
    public void testGetGlobalPolicyAlgorithm() throws Exception {
        Assert.assertNotNull(entitlementAdminClient.getGlobalPolicyAlgorithm(), "Getting the policy algorithm has " +
                "failed with null return.");
    }
    ...
    public void testDoTestRequest() throws Exception {
        Assert.assertNotNull(entitlementAdminClient.doTestRequest(REQUEST_1), "Testing the policy request has failed " +
                "with null return.");
    }

    @Test(groups = "wso2.is", description = "Check get PIP attribute finder data", dependsOnMethods =
            "testDoTestRequest")
...
//		TODO - fix request	
//		Assert.assertNotNull(entitlementAdminClient.getPIPAttributeFinderData
// ("urn:oasis:names:tc:xacml:1.0:subject:subject-id"), "Getting PIP attribute finder data has failed with null
// return.");
    }

    @Test(groups = "wso2.is", description = "Check get PIP resource finder data", dependsOnMethods =
            "testGetPIPAttributeFinderData")
    public void testGetPIPResourceFinderData() throws Exception {
        Assert.assertNotNull(entitlementAdminClient.getPIPResourceFinderData
                ("urn:oasis:names:tc:xacml:1.0:resource:resource-id"), "Getting PIP resouce finder data has failed " +
                "with null return.");
    }

    @Test(groups = "wso2.is", description = "Check get policy finder data", dependsOnMethods =
            "testGetPIPResourceFinderData")
    public void testGetPolicyFinderData() throws Exception {
        entitlementAdminClient.getPolicyFinderData("");
//		TODO - fix request		
//		Assert.assertNotNull(entitlementAdminClient.getPolicyFinderData(""), "Getting policy finder data has failed
// with null return.");
    }

    @Test(groups = "wso2.is", description = "Check refresh attribute finder", dependsOnMethods =
            "testGetPolicyFinderData")
    public void testRefreshAttributeFinder() throws Exception {
        entitlementAdminClient.refreshAttributeFinder("*");
    }

    @Test(groups = "wso2.is", description = "Check refresh policy finder", dependsOnMethods =
            "testRefreshAttributeFinder")
    public void testRefreshPolicyFinders() throws Exception {
        entitlementAdminClient.refreshPolicyFinders("*");
    }

    @Test(groups = "wso2.is", description = "Check refresh resouce finder", dependsOnMethods =
            "testRefreshPolicyFinders")
