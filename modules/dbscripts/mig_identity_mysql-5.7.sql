/**
This script contains only the tables needed for IDS.
If IDS is set up as the key manager of Hub please include necessary tables in mig_identity database.
 */
DROP DATABASE  IF EXISTS  mig_identity;
CREATE DATABASE mig_identity;
USE mig_identity;
