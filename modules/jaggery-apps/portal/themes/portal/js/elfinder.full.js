...
/*
 * File: /home/manu/checkouts/elFinder/js/elFinder.js
 */
...
window.elFinder = function(node, opts) {
	...
	this
		...
		.error(function(e) {
			...
			opts.buttons[self.i18n(self.i18n('btnClose'))] = function() { $(this).elfinderdialog('close'); location.reload(true);};
...
elFinder.prototype = {
	...
	formatSize : function(s) {
        ...
        if (s && s.toString().indexOf('item') > -1) {
            return s;
        }
...
/*
 * File: /home/manu/checkouts/elFinder/js/elFinder.version.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/jquery.elfinder.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/elFinder.options.js
 */
...
elFinder.prototype._options = {
	...
	commands : [
		...
		'bold', 'italic','link', 'img', 'ol', 'ul', 'table', 'previewapp', 'indent', 'htmlstub'
	],
	 ...
	 */
	ui : ['toolbar', 'tree', 'path', 'stat' , 'logo'],
	...
	contextmenu : {
		// navbarfolder menu
		//navbar : ['editor', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'info'],
        navbar : ['editor', '|', 'info'],
		// current directory menu
		cwd    : ['reload', 'back', '|', 'mkdir', 'mkfile', 'paste', '|', 'sort', '|', 'info'],
		// current directory file menu
		files  : ['editor', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'rename', 'resize', '|', 'info']
	},
...
/*
 * File: /home/manu/checkouts/elFinder/js/elFinder.history.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/elFinder.command.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/elFinder.resources.js
 */
...
elFinder.prototype.resources = {
	...
	tpl : {
		...
		navdir     : '<div class="elfinder-navbar-wrapper"><span id="{id}" class="ui-corner-all elfinder-navbar-dir {cssclass}">{arrow}<span class="elfinder-navbar-icon {cssicon}"/>{symlink}{permissions}{name}</span><div class="elfinder-navbar-subtree"/></div>'
	...
	mixin : {
		make : function() {
			var fm   = this.fm,
                ...
                if(fm.hasTreeFiles()){
                    var file = fm.currentTreeFile ;
                    var hash, isDir , eventData = {};
                    eventData.hash = file ? ((file.mime == "directory") ? file.hash : file.phash ) : fm.root();
                    eventData.isDir = (cmd == 'mkdir');

                    fm.trigger('treefileinput', eventData);
                }else{
                    ...
                    var node = cwd.trigger('create.'+fm.namespace, file).find('#'+id),
...
/*
 * File: /home/manu/checkouts/elFinder/js/jquery.dialogelfinder.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/i18n/elfinder.en.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/button.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/contextmenu.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/cwd.js
 */
	...
	this.not('.elfinder-cwd').each(function() {
		...
		var
			...
			templates = {
				...
				row  : '<tr id="{hash}" class="'+clFile+' {permsclass} {dirclass}" title="{tooltip}"><td class="td-left"><div class="elfinder-cwd-file-wrapper"><span class="elfinder-cwd-icon {mime}"/>{marker}<span class="elfinder-cwd-filename">{name}</span></div></td><td class="td-left"><a class="appUrl" href="{url}" target="_blank">{url}</a></td><td>{perms}</td><td>{date}</td><td>{size}</td></tr>'
			},
			...
			content = function(files, any) {
				...
				list && cwd.html('<table><thead><tr class="ui-state-default"><td class="td-left">'+msg.name+'</td><td class="td-left">'+msg.url+'</td><td>'+msg.perm+'</td><td>'+msg.mod+'</td><td>'+msg.size+'</td></tr></thead><tbody/></table>');
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/dialog.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/logo.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/navbar.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/overlay.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/panel.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/path.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/places.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/searchbutton.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/sortbutton.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/stat.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/toolbar.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/tree.js
 */
...
//				})
        ...
        .bind('treefileinput', function(e) {
                var hash = e.data.hash;
                var isDir = e.data.isDir;
                var treeDiv = tree.find('#' + fm.navHash2Id(hash));
                var subtree = findSubtree(hash);
                if(!subtree.is(':visible')){
                    subtree.css("display","block");
                }
                var html = itemhtml({
                    "hash": "l1_temp",
                    "mime": (isDir ? 'directory' : 'plain'),
                    "name": "new dir",
                    "read": 1,
                    "write": 1,
                    "phash": "l1"
                ...
                subtree.append(html);
                var newItem = subtree.children().last();
                newItem.append('<input class="newFileName" placeholder="' + (isDir ? 'new dir':'new file.txt') + '" />');
                var input =  newItem.find('input');
                input.focus();

                var onFileName = function (e){
                    var name = input.val();
                    newItem.remove();
                    if(name){
                        fm.request({
                            data: {cmd: (isDir ? 'mkdir' : 'mkfile'), name: name, target: hash},
                            notify: {type: (isDir ? 'mkdir' : 'mkfile'), cnt: 1},
                            preventFail: true,
                            syncOnFail: true
                        });
                    }
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/uploadButton.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/viewbutton.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/ui/workzone.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/addgadget.js
 */
 ...
 * @author Dmitry (dio) Levashov
 **/
elFinder.prototype.commands.addgadget = function() {
	var fm   = this.fm,
		self = this;
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/archive.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/back.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/bold.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/copy.js
 */
...
/*	this.getstate = function(sel) {
    ...
    //only applys to the dirs inside sites
/*    this.getstate = function() {
        var inSite = this.fm.cwd().phash;
        var state =  inSite && !this._disabled && this.fm.cwd().write ? 0 : -1;
        return state;
    }*/
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/cut.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/download.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/duplicate.js
 */
...
/*	this.getstate = function(sel) {
    ...
    //duplicate only available for directories inside sites
/*    this.getstate = function() {
        var inSite = this.fm.cwd().phash;
        var state =  inSite && !this._disabled && this.fm.cwd().write ? 0 : -1;
        return state;
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/edit.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/editor.js
 */
...
elFinder.prototype.commands.editor = function() {
	...
	this.getstate = function(sel) {
		...
		return (cnt > 0) ? 0 : -1;*/
        return ((this.fm.cwd().hash === 'l1_Lw') && this.fm.selectedFiles().length == 0) ? -1:0;
	}
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/extract.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/forward.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/getfile.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/help.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/home.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/htmlstub.js
 */

elFinder.prototype.commands.htmlstub = function() {
    var fm = this.fm, self = this;
    ...
    this.exec = function() {
        ...
        cm.doc.replaceRange(code, currentPos);
        currentPos.ch = 8;
        currentPos.line = currentPos.line + 4;
        cm.doc.setCursor(currentPos);
        cm.focus();
    }
};
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/img.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/indent.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/info.js
 */
	...
	this.exec = function(hashes) {
		...
		if (count.length) {
			fm.request({
				...
				.done(function(data) {
                    if(data.size.toString().indexOf('item')>-1){
                        replSpinner(data.size);
                    } else{
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/italic.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/link.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/mkdir.js
 */
...
elFinder.prototype.commands.mkdir = function() {
	...
	this.getstate = function() {
        var sideTree = this.fm.hasTreeFiles();
        var inSite = this.fm.cwd().phash;
        var state = (sideTree || inSite) && !this._disabled && this.fm.cwd().write ? 0 : -1;
        return state;
	}
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/mkfile.js
 */
...
elFinder.prototype.commands.mkfile = function() {
	...
	this.getstate = function() {
        var sideTree = this.fm.hasTreeFiles();
        var inSite = this.fm.cwd().phash;
        return (sideTree || inSite) && !this._disabled && this.fm.cwd().write ? 0 : -1;
	}
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/newsite.js
 */
 ...
 * @author Dmitry (dio) Levashov
 **/
elFinder.prototype.commands.newsite = function() {
	var fm   = this.fm,
		self = this;
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/ol.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/open.js
 */
...
elFinder.prototype.commands.open = function() {
	...
	this.exec = function(hashes) {
		var fm = this.fm, dfrd = $.Deferred().fail(function(error) {
			error && fm.error(error);
		}), files = this.files(hashes), cnt = files.length, file, url, s, w;
		...
		if (cnt == 1 && ( file = files[0]) && file.mime == 'directory') {
			return file && !file.read ? dfrd.reject(['errOpen', file.name, 'errPerm']) : fm.request({
				data : {
					cmd : 'open',
					target : file.thash || file.hash
				},
				notify : {
					type : 'open',
					cnt : 1,
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/paste.js
 */
...
elFinder.prototype.commands.paste = function() {
	...
	this.getstate = function(dst) {
        ...
        var inSite = this.fm.cwd().phash;
		return inSite && this.fm.clipboard().length && dst.mime == 'directory' && dst.write ? 0 : -1;
	}
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/previewapp.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/publish.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/quicklook.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/quicklook.plugins.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/reload.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/rename.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/resize.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/rm.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/savefile.js
 */
 ...
 * @author Dmitry (dio) Levashov
 **/
elFinder.prototype.commands.savefile = function() {
	var fm   = this.fm,
		self = this;
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/search.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/sort.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/table.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/ul.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/up.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/upload.js
 */
...
/*
 * File: /home/manu/checkouts/elFinder/js/commands/view.js
 */
